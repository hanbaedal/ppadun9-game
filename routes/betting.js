...
router.post('/predict', async (req, res) => {
    try {
        ...
        const db = req.app.locals.db;
        const collection = db.collection(BETTING_PREDICTIONS_COLLECTION);

        // 중복 예측 방지
        const existingPrediction = await collection.findOne({
        ...
        console.log(`예측 저장: 사용자 ${userId}, 예측: ${prediction}, 포인트: ${points}`);
